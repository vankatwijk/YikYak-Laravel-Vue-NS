                ...
                <nav class="container mx-auto flex items-center justify-between flex-wrap py-3">
                    ...
                    <div class="w-full block text-right flex-grow lg:flex lg:items-center lg:w-auto">
                        <div class="lg:flex-grow">
                            ...
                            <a href="{{route('login')}}" class="block mt-4 lg:inline-block lg:mt-0 text-grey-dark hover:text-grey-darker no-underline mr-6">
                                Login
                            </a>
                            <a href="{{route('register')}}" class="block mt-4 lg:inline-block lg:mt-0 text-grey-dark hover:text-grey-darker no-underline mr-6">
                                Register
                            </a>
                        </div>
                    </div>
            ...
            <main class="w-full">
                <div class="border-t-2 border-grey-lighter">
                    <div class="container mx-auto py-6">
                        <div class="flex mt-6">
                            <div class="w-1/2" style="background-color:pink;margin:20px;">
                                <!-- <img

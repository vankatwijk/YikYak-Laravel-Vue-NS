                ...
                <form class="w-full my-8" action="{{ route('companies.store') }}" method="POST">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input class="appearance-none block w-full bg-white text-grey-darker border border-grey-light rounded py-4 px-4 mb-3" id="company-name" name="name" type="text" placeholder="companyname">

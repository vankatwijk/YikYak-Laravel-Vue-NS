                            ...
                            <v-template>
                                ...
                                <StackLayout orientation="horizontal" style="border-bottom-width:1;border-bottom-color:#E4E4E4;" padding="10">
                                    <StackLayout width="20%">
                                        <Image :src="APIURL+'/uploads/avatars/'+item.to.avatar" stretch="aspectFill" class="conImg" />
                                    </StackLayout>
                                    <StackLayout marginLeft="10" paddingTop="3"
                                        width="50%">
                                        <Label :text="item.from.name" :class="'convFriendName '" />
                                        <Label :text="item.body" :class="'convTextOut '" />
                                    </StackLayout>
                    ...
                    <StackLayout dock="bottom" height="10%" style="border-color:#E4E4E4;border-width:1;background:#fff;">
                          <GridLayout columns="*, *, *,* ,*" verticalAlignment="top">
                            ...
                            <StackLayout col="3" class="navItem" @tap="conversationsTap()">
                                ...
                                <Label text="Messages"  style="font-size:10;"  :color="mainColor"/>
                            </StackLayout>
    ...
    export default {
        ...
        methods: {
            ...
            getresults(){
                ...
                httpModule.request({
                    url: appURL+'/api/inbox',//"http://192.168.0.83:8000/api/home",
                    method: "Get",
                    headers: { 

  ...
  <Page class="page">
    ...
    >
      ...
      >
        ...
        <StackLayout class="HMid" alignItems="left"> </StackLayout>
                ...
                <StackLayout paddingTop="5" backgroundColor="#E8E8E8">
                  <StackLayout class="noteContainer">
                    <StackLayout orientation="horizontal" padding="10">
                      <StackLayout>
                        <Label :text="note.title" class="postAuthotName" />
                        <Label
                          :text="
                            note.distance.toFixed(3) * 100 + ' meters away'
                          "
                          class="postDateSmall"
                        />
                      </StackLayout>
